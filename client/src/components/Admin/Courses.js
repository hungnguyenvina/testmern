...
import {loadCourses,approveRejectCourse,deleteCourse} from '../../redux/actions/courseAction';
    ...
    constructor(props) {
        ...
        this.state = { 
            ...
            columns: [
                ...
                {
                  label: "Category",
                  prop: "course_category_name",
                  align:'left',
                  width: 160,
                  render: function(data){
                    return (
                    <span>
                      <span style={{marginLeft: '10px',textAlign:'left'}}>{data.course_category_name}</span>
                    </span>)
                  }
                },
                {
...
const mapStateToProps = state => {
  console.log(state.courses);
	return {
		courses : state.course_reducer.all_courses
	};
}
