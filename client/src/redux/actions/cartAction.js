import {REMOVE_COURSE_FROM_CART_SUCCESS,ADD_COURSE_TO_CART_SUCCESS,LOAD_MULTIPLE_COURSES_SUCCESS} from './actionTypes';
...
export const addCourseToCartSuccess = (data) => {
    return {
        type: ADD_COURSE_TO_CART_SUCCESS,
        payload : data
    }
}
...
export const loadMultipleCoursesSucccess = (data) => {
    return {
        type: LOAD_MULTIPLE_COURSES_SUCCESS,
        payload : data
    }
}
...
export const removeCourseFromCartSuccess = (data) => {
    return {
        type: REMOVE_COURSE_FROM_CART_SUCCESS,
        payload : data
    }
}
